...
This is a web application that allows you to keep track of your favorite places that you have visited.
...
* `git clone https://github.com/sheenanick/java-places` to clone this repository
* `gradle run`
